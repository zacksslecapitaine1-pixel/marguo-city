  ...
  fr: {
    ...
    pages: {
      index: {
        ...
        rooms_sub: 'Climatisées ou ventilées, toutes nos chambres offrent le même soin du détail.',
  ...
  en: {
    ...
    pages: {
      index: {
        ...
        rooms_sub: 'Air-conditioned or fan-cooled, every room offers the same attention to detail.',
